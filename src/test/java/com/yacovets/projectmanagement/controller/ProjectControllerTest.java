...
public class ProjectControllerTest {
    ...
    public void getCookies() throws Exception {
        mockMvc.perform(
                post("/security/registration")
                        ...
                        .param("email", "Alex.email2@dev.ioc")
                        .param("username", "Alex2")
    ...
    @Test
    void createProjectHandler() throws Exception {
        mockMvc.perform(
                post("/project/create")
                        ...
                        .with(csrf())
                        .accept(MediaType.TEXT_HTML)
        ).andExpect(redirectedUrlPattern("/project/*"));
    }
}
